...
execute if block ~ 130 ~ air run tp @a ~ 130 ~
execute if block ~ 130 ~ air run spawnpoint @a ~ 130 ~

execute if block ~ 140 ~ air run tp @a ~ 140 ~
execute if block ~ 140 ~ air run spawnpoint @a ~ 140 ~

execute if block ~ 150 ~ air run tp @a ~ 150 ~
execute if block ~ 150 ~ air run spawnpoint @a ~ 150 ~

execute if block ~ 160 ~ air run tp @a ~ 160 ~
execute if block ~ 160 ~ air run spawnpoint @a ~ 160 ~

execute if block ~ 170 ~ air run tp @a ~ 170 ~
execute if block ~ 170 ~ air run spawnpoint @a ~ 170 ~

execute if block ~ 180 ~ air run tp @a ~ 180 ~
execute if block ~ 180 ~ air run spawnpoint @a ~ 180 ~

execute if block ~ 190 ~ air run tp @a ~ 190 ~
execute if block ~ 190 ~ air run spawnpoint @a ~ 190 ~

execute if block ~ 200 ~ air run tp @a ~ 200 ~
execute if block ~ 200 ~ air run spawnpoint @a ~ 200 ~

execute if block ~ 210 ~ air run tp @a ~ 210 ~
execute if block ~ 210 ~ air run spawnpoint @a ~ 210 ~

execute if block ~ 220 ~ air run tp @a ~ 220 ~
execute if block ~ 220 ~ air run spawnpoint @a ~ 220 ~

execute if block ~ 230 ~ air run tp @a ~ 230 ~
execute if block ~ 230 ~ air run spawnpoint @a ~ 230 ~

execute if block ~ 240 ~ air run tp @a ~ 240 ~
execute if block ~ 240 ~ air run spawnpoint @a ~ 240 ~
